const ApiRootUrl = 'http://localhost/api/';
...
module.exports = {
  ...
  AuthLogin: ApiRootUrl + 'auth/login', //账号密码登录
  AuthRegister: ApiRootUrl + 'auth/register', //账号注册
  AuthLogout: ApiRootUrl + 'auth/logout', //账号登出
  AuthChangePassword: ApiRootUrl + 'auth/changePassword', //修改密码
  AuthResetPassword: ApiRootUrl + 'auth/resetPassword', //忘记密码重置
  AuthLoginByWeixin: ApiRootUrl + 'auth/loginByWeixin', //微信登录，预留
  UserInfo: ApiRootUrl + 'user/info', //用户资料
  UserProfile: ApiRootUrl + 'user/profile', //修改用户资料
  UserPassword: ApiRootUrl + 'user/password', //修改密码
  UserAvatar: ApiRootUrl + 'user/saveAvatar', //上传头像
  ...
  PayBalance: ApiRootUrl + 'pay/balance', //余额支付
  UserBalance: ApiRootUrl + 'user/balance', //账户余额
  UserRecharge: ApiRootUrl + 'user/recharge', //充值卡充值
